...
use warlock_tui::{
    Activities, Activity, App, Cancel, ClaudeAgent, Focus, Hit, Outcome, PactToggle, Section,
    Watch, WatchPolicy, Watching, draw, hit_test, panel_height, reseat_on, tree_height,
};
...
fn mouse_action(mouse: MouseEvent, size: Size, app: &App) -> Option<MouseAction> {
